...
#            self.__now_pointlist[-1][0] = int(self.__now_pointlist[-2][0] + self.__frame)
#            self.__now_pointlist[-1][1] = int(self.__now_pointlist[-2][1] + (rate * self.__pointlist[self.__now_pointlist_index][1]))
#        else:
#            self.__now_pointlist[-1][0] = int(self.__now_pointlist[-2][0] + (rate * self.__pointlist[self.__now_pointlist_index][0]))
#            self.__now_pointlist[-1][1] = int(self.__now_pointlist[-2][1] + self.__frame)
        if 0 == self.__frame_target:
